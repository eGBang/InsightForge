...
#[derive(Debug)]
pub struct InsightForgeProcessor {
    verbose: bool,
    processed_count: usize,
}

impl InsightForgeProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting InsightForge processing");
    
    let mut processor = InsightForgeProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = InsightForgeProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = InsightForgeProcessor::new(false);
